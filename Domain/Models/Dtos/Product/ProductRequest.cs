...
namespace Product.api.Domain.Models.Dtos.Product
{
    public class ProductRequest : AbstractRequest<ProductRequest>
    {
        ...
        public ProductRequest(string name, string code, long quantity, string expirationDate)
        {
            this.Name = name;
            this.Code = code;
        ...
        [JsonIgnore]
        protected override ValidationResult ValidatorResult => new ProductValidator().Validate(this);
